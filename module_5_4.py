...
class User:
    """
    Класс User представляет пользователя
...
class Video:
    """
    Класс Video представляет атрибуты и функции параметров видео
...
class UrTube:
    """
    Класс UrTube собирает и включает методы для взаимодействия пользователя и видео вместе
